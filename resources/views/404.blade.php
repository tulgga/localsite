        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="error-text">
                    ...
                    <p>Баянхонгор аймаг цахим мэдээллийн нэгдсэн систем</p>
                    <a href="https://bayankhongor.gov.mn" class="btn btn-primary btn-round">Нүүр хуудас</a>
                </div>
            </div>
        </div>
    </div>

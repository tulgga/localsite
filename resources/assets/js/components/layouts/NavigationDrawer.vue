            ...
            return {
                ...
                items: [
                    ...
                    { subheader: 'Мэдээ',  role:1 },
                        ...
                        { title: "Мэдээ, нийтлэл", icon: 'fas fa-newspaper', path: '/news' ,  role:1},
                        { title: "Шуурхай мэдээ", icon: 'fas fa-newspaper', path: '/break_news' ,  role:1},
                    ...
                    { title: "Мэдээ, нийтлэл", icon: 'fas fa-newspaper', path: '/sub_news' ,  role:3},

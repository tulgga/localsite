    ...
    export default {
        data(){
            return {
                ...
                is_loading:false,
                user:false,
                columns: ['id',  'image',  'title',  'cat',  'type', 'is_primary',   'status',   'created_at', 'view_count', 'action'],
                options: {
                    perPage: 25,
...
<style>
    ...
    tr td:nth-child(0), tr td:nth-child(5), tr td:nth-child(6), tr td:nth-child(7), tr td:nth-child(9){

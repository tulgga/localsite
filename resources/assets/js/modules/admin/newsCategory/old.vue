    ...
    <div>
        ...
        <div class="boxed">
            ...
            <div class="boxed-title">
                <div class="boxed-item-center title">Мэдээний ангилал</div>
            </div>
        ...
        <div class="modal is-active" v-if="deletemodal">
            ...
            <div class="modal-card modal-card-small">
                <header class="modal-card-head">
                    <p class="modal-card-title">Мэдээний ангилал устгах</p>
                </header>
            ...
            <div class="modal-card modal-card-small">
                <header class="modal-card-head">
                    <p  class="modal-card-title ">
                        <template v-if="insert_cat.id==0">Мэдээний ангилал нэмэх</template>
                        <template v-else>Мэдээний ангилал засах</template>
                    </p>
                </header>
                <section class="modal-card-body">
                    <div class="field" >
    ...
    export default {
        ...
        methods: {
            ...
            nemeh: function(){
                ...
                axios.post('/news_category', formData)
                    .then((response) => {
                        if(response.data.success===0){
                            alert('дэд ангилалтай мэдээний ангилал байна. эх ангилал харьяалагдах боломжгүй');
            ...
            ustga: function(){
                ...
                axios.post('/news_category/delete', formData).then((response) => {
            ...
            changePositionMain(index, action){
                ...
                this.fetched = false;
                axios.post('/news_category/change', formData).then((response) => {
                    this.fetched = true;
                    this.fetchData();
                    this.is_loading = false;
            ...
            changePosition(index, subindex, action){
                ...
                formData.append('data', JSON.stringify(send));
                this.fetched=false
                axios.post('/news_category/change', formData).then((r) => {
                    this.fetchData();
                    this.fetched=true
                    this.is_loading = false;
                    this.$toasted.global.toast_success({message: 'Амжилттай хадгаллаа'}); // delete success toast

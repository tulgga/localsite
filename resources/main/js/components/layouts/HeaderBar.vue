                    ...
                    <div class="container">
                        <nav class="level mb-0">
                            ...
                            <div class="level-right mr-1">
                                ...
                                <p class="level-item"><a href="!#/able" style="padding: 1px 5px; background: rgb(226, 59, 59);" target="_blank" ><img :src="siteUrl+'/images/able.png'" style="height: 12px; margin-top: 5px;" /></a></p>
                            </div>
                        </nav>
